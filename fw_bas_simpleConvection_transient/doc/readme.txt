...
Problems with transient computation:
Changing nummber of timesteps changes the result, fewer timesteps leads to a result closer to steady state, a lot more timesteps lead to a result where every cell is 10 degrees.
