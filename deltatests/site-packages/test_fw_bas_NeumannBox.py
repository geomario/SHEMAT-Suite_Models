...
class Tests_fw_bas_NeumannBox(unittest.TestCase):
    def test_comp_equal(self):

        fhdf1 = h5py.File(std.shemat_suite_models_dir +
                          '/fw_bas_NeumannBox' + std.result_dir +
                          '/NeumannBox_final.h5')
        ...
        fhdf2 = h5py.File(
            ...
            '/fw_bas_NeumannBox/NeumannBox_final.h5')
...
def local_suite():
    local_suite = unittest.makeSuite(Tests_fw_bas_NeumannBox, prefix='test')
    return local_suite
