...
class Tests_fw_basc_HenryProblem(unittest.TestCase):
    def test_conc0001_equal(self):

        conc0001_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['conc0001']
        conc0001_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['conc0001']
    ...
    def test_comp_equal(self):
        ...
        comp_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['comp']
        comp_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['comp']
    ...
    def test_uindex_equal(self):
        ...
        uindex_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['uindex']
        uindex_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['uindex']
    ...
    def test_por_equal(self):
        ...
        por_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['por']
        por_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['por']
    ...
    def test_temp_equal(self):
        ...
        temp_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['temp']
        temp_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['temp']
    ...
    def test_lx_equal(self):
        ...
        lx_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['lx']
        lx_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['lx']
    ...
    def test_ly_equal(self):
        ...
        ly_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['ly']
        ly_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['ly']
    ...
    def test_lz_equal(self):
        ...
        lz_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['lz']
        lz_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['lz']
    ...
    def test_head_equal(self):
        ...
        head_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['head']
        head_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['head']
    ...
    def test_pres_equal(self):
        ...
        pres_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['pres']
        pres_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['pres']
    ...
    def test_kx_equal(self):
        ...
        kx_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['kx']
        kx_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['kx']
    ...
    def test_ky_equal(self):
        ...
        ky_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['ky']
        ky_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['ky']
    ...
    def test_kz_equal(self):
        ...
        kz_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['kz']
        kz_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['kz']
    ...
    def test_rhof_equal(self):
        ...
        rhof_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['rhof']
        rhof_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['rhof']
    ...
    def test_visf_equal(self):
        ...
        visf_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/result/henry_final.h5')['visf']
        visf_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_HenryProblem/henry_final.h5')['visf']
...
def local_suite():
    local_suite = unittest.makeSuite(
        Tests_fw_basc_HenryProblem, prefix='test')
    return local_suite
