...
class Tests_fw_const_Peclet_up(unittest.TestCase):
    def test_uindex_equal(self):
        ...
        fhdf1 = h5py.File(std.shemat_suite_models_dir + '/fw_const_Peclet_up' +
                          std.result_dir + '/Peclet_up_final.h5')
        uindex_array_desired = np.array(fhdf1['uindex'])
        fhdf1.close()

        fhdf2 = h5py.File(std.shemat_suite_models_dir +
                          '/fw_const_Peclet_up/Peclet_up_final.h5')
...
def local_suite():
    local_suite = unittest.makeSuite(Tests_fw_const_Peclet_up, prefix='test')
    return local_suite
