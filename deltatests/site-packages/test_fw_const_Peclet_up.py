...
class Tests_fw_const_Peclet_up(unittest.TestCase):
    def test_uindex_equal(self):

        uindex_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/result/Peclet_up_final.h5')['uindex']
        uindex_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/Peclet_up_final.h5')['uindex']
    ...
    def test_por_equal(self):
        ...
        por_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/result/Peclet_up_final.h5')['por']
        por_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/Peclet_up_final.h5')['por']
    ...
    def test_temp_equal(self):
        ...
        temp_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/result/Peclet_up_final.h5')['temp']
        temp_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/Peclet_up_final.h5')['temp']
    ...
    def test_lx_equal(self):
        ...
        lx_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/result/Peclet_up_final.h5')['lx']
        lx_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/Peclet_up_final.h5')['lx']
    ...
    def test_ly_equal(self):
        ...
        ly_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/result/Peclet_up_final.h5')['ly']
        ly_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/Peclet_up_final.h5')['ly']
    ...
    def test_lz_equal(self):
        ...
        lz_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/result/Peclet_up_final.h5')['lz']
        lz_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/Peclet_up_final.h5')['lz']
    ...
    def test_head_equal(self):
        ...
        head_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/result/Peclet_up_final.h5')['head']
        head_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/Peclet_up_final.h5')['head']
    ...
    def test_pres_equal(self):
        ...
        pres_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/result/Peclet_up_final.h5')['pres']
        pres_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/Peclet_up_final.h5')['pres']
    ...
    def test_kx_equal(self):
        ...
        kx_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/result/Peclet_up_final.h5')['kx']
        kx_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/Peclet_up_final.h5')['kx']
    ...
    def test_ky_equal(self):
        ...
        ky_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/result/Peclet_up_final.h5')['ky']
        ky_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/Peclet_up_final.h5')['ky']
    ...
    def test_kz_equal(self):
        ...
        kz_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/result/Peclet_up_final.h5')['kz']
        kz_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/Peclet_up_final.h5')['kz']
    ...
    def test_rhof_equal(self):
        ...
        rhof_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/result/Peclet_up_final.h5')['rhof']
        rhof_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_const_Peclet_up/Peclet_up_final.h5')['rhof']
...
def local_suite():
    local_suite = unittest.makeSuite(
        Tests_fw_const_Peclet_up, prefix='test')
    return local_suite
