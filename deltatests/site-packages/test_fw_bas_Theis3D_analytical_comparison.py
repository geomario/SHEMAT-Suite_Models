...
class Tests_fw_bas_Theis3D_analytical_comparison(unittest.TestCase):
    def test_comp_equal(self):
        ...
        fhdf2 = h5py.File(
            ...
            '/fw_bas_Theis3D_analytical_comparison/Theis3D_final.h5')
...
def local_suite():
    local_suite = unittest.makeSuite(
        Tests_fw_bas_Theis3D_analytical_comparison, prefix='test')
    return local_suite
