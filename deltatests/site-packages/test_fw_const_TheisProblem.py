...
class Tests_fw_const_TheisProblem(unittest.TestCase):
    ...
    def test_por_equal(self):
        ...
        por_array_desired = pf.my_vtk_to_numpy(
            pf.my_vtk(
                std.shemat_suite_models_dir + '/fw_const_TheisProblem' +
                std.result_dir + '', 'THEIS_final.vtk', 'por'))
    ...
    def test_head_equal(self):
        ...
        head_array_desired = pf.my_vtk_to_numpy(
            pf.my_vtk(
                std.shemat_suite_models_dir + '/fw_const_TheisProblem' +
                std.result_dir + '', 'THEIS_final.vtk', 'head'))
    ...
    def test_pres_equal(self):
        ...
        pres_array_desired = pf.my_vtk_to_numpy(
            pf.my_vtk(
                std.shemat_suite_models_dir + '/fw_const_TheisProblem' +
                std.result_dir + '', 'THEIS_final.vtk', 'pres'))
        pres_array_actual = pf.my_vtk_to_numpy(
            pf.my_vtk(std.shemat_suite_models_dir + '/fw_const_TheisProblem',
                      'THEIS_final.vtk', 'pres'))
    ...
    def test_kx_equal(self):
        ...
        kx_array_desired = pf.my_vtk_to_numpy(
            pf.my_vtk(
                std.shemat_suite_models_dir + '/fw_const_TheisProblem' +
                std.result_dir + '', 'THEIS_final.vtk', 'kx'))
    ...
    def test_ky_equal(self):
        ...
        ky_array_desired = pf.my_vtk_to_numpy(
            pf.my_vtk(
                std.shemat_suite_models_dir + '/fw_const_TheisProblem' +
                std.result_dir + '', 'THEIS_final.vtk', 'ky'))
    ...
    def test_rhof_equal(self):
        ...
        rhof_array_desired = pf.my_vtk_to_numpy(
            pf.my_vtk(
                std.shemat_suite_models_dir + '/fw_const_TheisProblem' +
                std.result_dir + '', 'THEIS_final.vtk', 'rhof'))
        rhof_array_actual = pf.my_vtk_to_numpy(
            pf.my_vtk(std.shemat_suite_models_dir + '/fw_const_TheisProblem',
                      'THEIS_final.vtk', 'rhof'))
...
def local_suite():
    local_suite = unittest.makeSuite(
        Tests_fw_const_TheisProblem, prefix='test')
    return local_suite
