...
class Tests_fw_ice_GeoSlope2(unittest.TestCase):
    def test_comp_equal(self):

        fhdf1 = h5py.File(std.shemat_suite_models_dir +
                          '/fw_ice_GeoSlope2' + std.result_dir +
                          '/GeoSlope_final.h5')
        ...
        fhdf2 = h5py.File(
            ...
            '/fw_ice_GeoSlope2/GeoSlope_final.h5')
...
def local_suite():
    local_suite = unittest.makeSuite(Tests_fw_ice_GeoSlope2, prefix='test')
    return local_suite
