...
class Tests_fw_basc_SaltFlow(unittest.TestCase):
    ...
    def test_por_equal(self):
        ...
        por_array_desired = pf.my_vtk_to_numpy(
            pf.my_vtk(
                std.shemat_suite_models_dir + '/fw_basc_SaltFlow' +
                std.result_dir + '', 'salt_final.vtk', 'por'))
    ...
    def test_head_equal(self):
        ...
        head_array_desired = pf.my_vtk_to_numpy(
            pf.my_vtk(
                std.shemat_suite_models_dir + '/fw_basc_SaltFlow' +
                std.result_dir + '', 'salt_final.vtk', 'head'))
    ...
    def test_kx_equal(self):
        ...
        kx_array_desired = pf.my_vtk_to_numpy(
            pf.my_vtk(
                std.shemat_suite_models_dir + '/fw_basc_SaltFlow' +
                std.result_dir + '', 'salt_final.vtk', 'kx'))
    ...
    def test_ky_equal(self):
        ...
        ky_array_desired = pf.my_vtk_to_numpy(
            pf.my_vtk(
                std.shemat_suite_models_dir + '/fw_basc_SaltFlow' +
                std.result_dir + '', 'salt_final.vtk', 'ky'))
    ...
    def test_kz_equal(self):
        ...
        kz_array_desired = pf.my_vtk_to_numpy(
            pf.my_vtk(
                std.shemat_suite_models_dir + '/fw_basc_SaltFlow' +
                std.result_dir + '', 'salt_final.vtk', 'kz'))
    ...
    def test_rhof_equal(self):
        ...
        rhof_array_desired = pf.my_vtk_to_numpy(
            pf.my_vtk(
                std.shemat_suite_models_dir + '/fw_basc_SaltFlow' +
                std.result_dir + '', 'salt_final.vtk', 'rhof'))
    ...
    def test_tracer1_equal(self):
        ...
        tracer1_array_desired = pf.my_vtk_to_numpy(
            pf.my_vtk(
                std.shemat_suite_models_dir + '/fw_basc_SaltFlow' +
                std.result_dir + '', 'salt_final.vtk', 'tracer1'))
        tracer1_array_actual = pf.my_vtk_to_numpy(
            pf.my_vtk(std.shemat_suite_models_dir + '/fw_basc_SaltFlow',
                      'salt_final.vtk', 'tracer1'))
...
def local_suite():
    local_suite = unittest.makeSuite(Tests_fw_basc_SaltFlow, prefix='test')
    return local_suite
