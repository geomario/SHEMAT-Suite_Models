...
class Tests_fw_const_Theis_analytical_centered(unittest.TestCase):
    def test_comp_equal(self):
        ...
        fhdf2 = h5py.File(
            ...
            '/fw_const_Theis_analytical_centered/THEIS_final.h5')
...
def local_suite():
    local_suite = unittest.makeSuite(
        Tests_fw_const_Theis_analytical_centered, prefix='test')
    return local_suite
