...
class Tests_fw_basc_ElderProblem_transient(unittest.TestCase):
    def test_conc0001_equal(self):

        fhdf1 = h5py.File(std.shemat_suite_models_dir +
                          '/fw_basc_ElderProblem_transient' + std.result_dir +
                          '/benchmark_elder_basc_final.h5')
        conc0001_array_desired = np.array(fhdf1['conc0001'])
        fhdf1.close()

        fhdf2 = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_basc_ElderProblem_transient/benchmark_elder_basc_final.h5')
        conc0001_array_actual = np.array(fhdf2['conc0001'])
        fhdf2.close()

        npt.assert_allclose(
            conc0001_array_actual, conc0001_array_desired, rtol=1e-8)
    ...
    def test_comp_equal(self):
        ...
        npt.assert_allclose(comp_array_actual, comp_array_desired, rtol=1e-8)
    ...
    def test_uindex_equal(self):
        ...
        npt.assert_allclose(
            uindex_array_actual, uindex_array_desired, rtol=1e-8)
    ...
    def test_por_equal(self):
        ...
        npt.assert_allclose(por_array_actual, por_array_desired, rtol=1e-8)
    ...
    def test_temp_equal(self):
        ...
        npt.assert_allclose(temp_array_actual, temp_array_desired, rtol=1e-8)
    ...
    def test_lx_equal(self):
        ...
        npt.assert_allclose(lx_array_actual, lx_array_desired, rtol=1e-8)
    ...
    def test_ly_equal(self):
        ...
        npt.assert_allclose(ly_array_actual, ly_array_desired, rtol=1e-8)
    ...
    def test_lz_equal(self):
        ...
        npt.assert_allclose(lz_array_actual, lz_array_desired, rtol=1e-8)
    ...
    def test_head_equal(self):
        ...
        npt.assert_allclose(head_array_actual, head_array_desired, rtol=1e-8)
    ...
    def test_pres_equal(self):
        ...
        npt.assert_allclose(pres_array_actual, pres_array_desired, rtol=1e-8)
    ...
    def test_kx_equal(self):
        ...
        npt.assert_allclose(kx_array_actual, kx_array_desired, rtol=1e-8)
    ...
    def test_ky_equal(self):
        ...
        npt.assert_allclose(ky_array_actual, ky_array_desired, rtol=1e-8)
    ...
    def test_kz_equal(self):
        ...
        npt.assert_allclose(kz_array_actual, kz_array_desired, rtol=1e-8)
    ...
    def test_rhof_equal(self):
        ...
        npt.assert_allclose(rhof_array_actual, rhof_array_desired, rtol=1e-8)


def local_suite():
    local_suite = unittest.makeSuite(Tests_fw_basc_ElderProblem_transient, prefix='test')
    return local_suite
