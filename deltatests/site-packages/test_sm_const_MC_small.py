...
class Tests_sm_const_MC_small(unittest.TestCase):
    def test_comp_equal(self):

        for i in range(1, 5):
            fhdf1 = h5py.File(
                std.shemat_suite_models_dir +
                '/sm_const_MC_small/result/samples_output/Synres1_E0_' +
                str(i) + '.h5')
            comp_array_desired = np.array(fhdf1['comp'])
            fhdf1.close()

            fhdf2 = h5py.File(std.shemat_suite_models_dir +
                              '/sm_const_MC_small/samples_output/Synres1_E0_' +
                              str(i) + '.h5')
    ...
    def test_por_equal(self):
        ...
        for i in range(1, 5):
            ...
            npt.assert_allclose(
                por_array_actual, por_array_desired, rtol=1e-5)
    ...
    def test_lx_equal(self):
        ...
        for i in range(1, 5):
            ...
            npt.assert_allclose(
                lx_array_actual, lx_array_desired, rtol=1e-5)
    ...
    def test_ly_equal(self):
        ...
        for i in range(1, 5):
            ...
            npt.assert_allclose(
                ly_array_actual, ly_array_desired, rtol=1e-5)
    ...
    def test_lz_equal(self):
        ...
        for i in range(1, 5):
            ...
            npt.assert_allclose(
                lz_array_actual, lz_array_desired, rtol=1e-5)
    ...
    def test_kx_equal(self):
        ...
        for i in range(1, 5):
            ...
            npt.assert_allclose(
                kx_array_actual, kx_array_desired, rtol=1e-5)
    ...
    def test_ky_equal(self):
        ...
        for i in range(1, 5):
            ...
            npt.assert_allclose(
                ky_array_actual, ky_array_desired, rtol=1e-5)
    ...
    def test_kz_equal(self):
        ...
        for i in range(1, 5):
            ...
            npt.assert_allclose(
                kz_array_actual, kz_array_desired, rtol=1e-5)
...
def local_suite():
    local_suite = unittest.makeSuite(Tests_sm_const_MC_small, prefix='test')
    return local_suite
