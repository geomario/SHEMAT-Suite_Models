...
class Tests_fw_basc_ElderProblem(unittest.TestCase):
    def test_conc0001_equal(self):

        fhdf1 = h5py.File(std.shemat_suite_models_dir +
                          '/fw_basc_ElderProblem' + std.result_dir +
        ...
        fhdf2 = h5py.File(
            ...
            '/fw_basc_ElderProblem/benchmark_elder_basc_final.h5')
    ...
    def test_head_equal(self):
        ...
        npt.assert_allclose(head_array_actual, head_array_desired, rtol=1e-7)
...
def local_suite():
    local_suite = unittest.makeSuite(Tests_fw_basc_ElderProblem, prefix='test')
    return local_suite
