...
class Tests_fw_pres_bas_2Dfancy_ForcedConvection(unittest.TestCase):
    def test_comp_equal(self):

        fhdf1 = h5py.File(std.shemat_suite_models_dir +
                          '/fw_pres_bas_2Dfancy_ForcedConvection' +
                          std.result_dir + '/forced_convection_final.h5')
        comp_array_desired = np.array(fhdf1['comp'])
        fhdf1.close()

        fhdf2 = h5py.File(
            std.shemat_suite_models_dir +
            '/fw_pres_bas_2Dfancy_ForcedConvection/forced_convection_final.h5')
...
def local_suite():
    local_suite = unittest.makeSuite(
        Tests_fw_pres_bas_2Dfancy_ForcedConvection, prefix='test')
    return local_suite
