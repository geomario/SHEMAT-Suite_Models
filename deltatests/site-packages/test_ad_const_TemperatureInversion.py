...
class Tests_ad_const_TemperatureInversion(unittest.TestCase):
    def test_uindex_equal(self):
        ...
        uindex_array_desired = h5py.File(
            ...
            '/ad_const_TemperatureInversion/result/oed_inv_final.h5')['uindex']
        uindex_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/oed_inv_final.h5')['uindex']
    ...
    def test_por_equal(self):
        ...
        por_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/result/oed_inv_final.h5')['por']
        por_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/oed_inv_final.h5')['por']
    ...
    def test_temp_equal(self):
        ...
        temp_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/result/oed_inv_final.h5')['temp']
        temp_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/oed_inv_final.h5')['temp']
    ...
    def test_lx_equal(self):
        ...
        lx_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/result/oed_inv_final.h5')['lx']
        lx_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/oed_inv_final.h5')['lx']
    ...
    def test_ly_equal(self):
        ...
        ly_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/result/oed_inv_final.h5')['ly']
        ly_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/oed_inv_final.h5')['ly']
    ...
    def test_lz_equal(self):
        ...
        lz_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/result/oed_inv_final.h5')['lz']
        lz_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/oed_inv_final.h5')['lz']
    ...
    def test_head_equal(self):
        ...
        head_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/result/oed_inv_final.h5')['head']
        head_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/oed_inv_final.h5')['head']
    ...
    def test_pres_equal(self):
        ...
        pres_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/result/oed_inv_final.h5')['pres']
        pres_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/oed_inv_final.h5')['pres']
    ...
    def test_kx_equal(self):
        ...
        kx_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/result/oed_inv_final.h5')['kx']
        kx_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/oed_inv_final.h5')['kx']
    ...
    def test_ky_equal(self):
        ...
        ky_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/result/oed_inv_final.h5')['ky']
        ky_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/oed_inv_final.h5')['ky']
    ...
    def test_kz_equal(self):
        ...
        kz_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/result/oed_inv_final.h5')['kz']
        kz_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/oed_inv_final.h5')['kz']
    ...
    def test_rhof_equal(self):
        ...
        rhof_array_desired = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/result/oed_inv_final.h5')['rhof']
        rhof_array_actual = h5py.File(
            std.shemat_suite_models_dir +
            '/ad_const_TemperatureInversion/oed_inv_final.h5')['rhof']
