...
* Compilation on CLAIX-18:
 (i) make fw hdf PROP=const COMPTYPE=ling64 HDF5_LIB=$HDF5_ROOT/lib HDF5_MOD=$HDF5_ROOT/include -j 8 
 (ii) make pres fw hdf PROP=const COMPTYPE=ling64 HDF5_LIB=$HDF5_ROOT/lib HDF5_MOD=$HDF5_ROOT/include -j 8 
